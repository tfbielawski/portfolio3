...
import { TrainingData } from "../helper/TrainingData";
...
const Training = () => {
  ...
  return (    
    <>
        <div className="pt-82 w-full md:h-screen text-gray-300 bg-[#0a192f] ">  
            <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
                <div className="pb-8">
                <p className="text-4xl font-bold inline underline decoration-[#6fc2b0] text-gray-300 border-[#6fc2b0]">Other Training</p>
                </div>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
                {TrainingData.map(({ id, image, name, description, url}) => (                    
                    <>                    
                        <div
                            ...
                            {/* Hover */}
                            <label className="text-center rounded-lg px-4 py-3 m-2 text-gray font-bold text-lg">{name}</label>
