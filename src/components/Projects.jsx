...
const Projects = () => {
  return (
    <div className="pt-20 w-full md:h-screen text-gray-300 bg-[#0a192f] ">
        <div className="max-w-[1000px] mx-auto flex flex-col justify-center w-full h-full bg-[#0a192f]">
                ...
                <div 
                    ...
                    <div className="opacity-0 group-hover:opacity-100">
                        ...
                        <div className="pt-8 text-center ">
                            ...
                            <p className="text-sm">NASA Space Photo of the Day API</p>
                        </div>
                    </div>
                </div>
                ...
                <div 
                    ...
                    <div className="opacity-0 group-hover:opacity-100">
                        ...
                        <div className="pt-8 text-center ">
                            ...
                            <p className="text-sm">Dungeons & Dragons Campaign Helper</p>
                        </div>
                    </div>
                </div>
                ...
                <div 
                    ...
                    <div className="opacity-0 group-hover:opacity-100">
                        ...
                        <div className="pt-8 text-center ">                         
                            ...
                            <p className="text-base">React Essentials Info App</p>
                        </div>
                    </div>
                </div>
                {/* Investment Planner  */}
