...
const Navbar = () => {
  ...
  return (
    <div className="flex fixed w-full h-[5rem] justify-between items-center px-4 bg-[#08192f] text-gray-300">
        <img 
            className="hidden lg:flex max-w-full h-auto size-36 pt-12"
            src={EGA7} 
            alt="Logo image" 
          />
      <div >
      ...
      {/* md: is a breakpoint for mobile */}
        <div className="hidden md:flex flex-row justify-between ">       
          ...
          <button className="text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#6fc2b0] hover:border-bg-[#6fc2b0]"><Link to="/training"> Other Training </Link></button>
        </div>
